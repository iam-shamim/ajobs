...
class homeController extends Controller{
    ...
    public function index(){
        ...
        $bestCompanyJobs=DB::table('jobs')->select(DB::raw('count(*) as jobsCont,employers.id,companies.companyName,companies.logo'))->leftJoin('employers','employers.id','=','jobs.employerID')->leftJoin('companies','employers.companyID','=','companies.id')->groupBy('jobs.employerID')->orderBy('jobsCont','DESC')->take(6)->get();
