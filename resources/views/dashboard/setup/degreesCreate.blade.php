            ...
            <div class="col-sm-6 col-sm-offset-3">
                <form action="{!! route('degrees.store') !!}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{!! old('degreeName') !!}" class="form-control" name="degreeName" id="degreeName">
                    </div>
                    <div class="form-group">
                        <label for="serial">Degree Serial</label>
                        <input type="number" name="serial" value="{!! old('serial') !!}" class="form-control" id="serial">
                    </div>
                    <input type="submit" value="Degree Save" class="form-control btn-primary">
                </form>
            </div>
        </div>
    </div>
